...
class PolypModel(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.num_stages):
            ...
            outs.append(out)
        br = outs[-2]
        topx =  resize(topx, size=br.size()[2:], mode='bilinear', align_corners=False)
        outs[-2] = br + topx
    ...
    def train(self, mode=True):
        ...
        super(PolypModel, self).train(mode) 
